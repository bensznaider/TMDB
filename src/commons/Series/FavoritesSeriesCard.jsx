...
const FavoritesSeriesCard = ({ favorito }) => {
  ...
  const handleClick = () => {
    const options = {
      method: 'GET',
      url: `https://api.themoviedb.org/3/tv/${favorito.tmdbId}?language=es`,
      headers: {
    ...
    axios
      ...
      .then(function (response) {
        ...
        navigate("/favorites/series/selected-favorite");
      })
...
export default FavoritesSeriesCard;
